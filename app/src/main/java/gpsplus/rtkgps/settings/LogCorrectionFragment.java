...
public class LogCorrectionFragment extends LogRoverFragment {
    ...
    private static final String SHARED_PREFS_NAME = "LogCorrection";

    private static final SettingsHelper.LogStreamDefaults DEFAULTS = new SettingsHelper.LogStreamDefaults();

    static {
        DEFAULTS.setEnabled(false).setFileClientDefaults(new StreamFileClientFragment.Value().setFilename("correction_%Y%m%d%h%M%S.log"));
    }
    ...
    protected void initPreferenceScreen() {
        ...
        if (enablePref != null) {
            enablePref.setTitle(R.string.log_streams_settings_enable_correction_title);
        }
    }
