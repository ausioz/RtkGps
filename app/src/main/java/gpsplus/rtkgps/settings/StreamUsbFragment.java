...
public class StreamUsbFragment extends PreferenceFragmentCompat {
    ...
    public void onResume() {
        ...
        Objects.requireNonNull(getPreferenceManager().getSharedPreferences()).registerOnSharedPreferenceChangeListener(
    ...
    public void onPause() {
        ...
        Objects.requireNonNull(getPreferenceManager().getSharedPreferences()).unregisterOnSharedPreferenceChangeListener(
                mPreferenceChangeListener);
        super.onPause();
    }
    ...
    private static SerialLineConfiguration readSerialLineConfiguration(SharedPreferences prefs) {
        ...
        if (baudrate != null) conf.setBaudrate(Integer.parseInt(baudrate));
        if (dataBits != null) conf.setDataBits(Integer.parseInt(dataBits));
