...
public class ToolsActivity extends Activity implements IDownloaderAccessResponse{
    ...
    View.OnClickListener eventHandler = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            v.setEnabled(false);
            int viewId = v.getId();
            if (viewId == R.id.tools_button_igu) {
                getIGUEphemeris();
            } else if (viewId == R.id.tools_button_raf09) {
                getRAF09Model();
            } else if (viewId == R.id.tools_button_egm2008_m25) {
                getEGM2008_M25Model();
            } else if (viewId == R.id.tools_button_egm2008_m10) {
                getEGM2008_M10Model();
            } else if (viewId == R.id.tools_button_egm96_m150) {
                getEGM96_M150Model();
            }
        }
    };
