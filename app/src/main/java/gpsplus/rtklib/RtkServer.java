...
public class RtkServer {
    ...
    private static final String TAG = RtkServer.class.getSimpleName();
    ...
    private final RtkServerSettings mSettings;
    ...
    public void getStreamStatus(RtkServerStreamStatus status) {
    ...
    public void getBaseObservationStatus(RtkServerObservationStatus status) {
        getObservationStatus(RtkServer.RECEIVER_BASE, status);
    }

    public void getRoverObservationStatus(RtkServerObservationStatus status) {
        getObservationStatus(RtkServer.RECEIVER_ROVER, status);
    }
