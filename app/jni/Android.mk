...
LOCAL_MODULE    := rtkgps
LOCAL_CFLAGS += -fvisibility=hidden -fPIC -D_FORTIFY_SOURCE=2
...
# LOCAL_STATIC_LIBRARIES += gdalalljni
...
LOCAL_CFLAGS    := -DJNI_ENABLED=1 -fPIC -D_FORTIFY_SOURCE=2
LOCAL_LDLIBS := -lm
LOCAL_LDLIBS += -llog
LOCAL_SRC_FILES := \
